...
zepto.fragment = function (html, name, properties) {
    ...
    if (!dom) {
        ...
        //取容器的子节点
        dom = $.each(slice$1.call(container.childNodes), function () {
...
$.fn = {
    ...
    not: function (selector) {
        ...
        if (isFunction(selector) && selector.call !== undefined) this.each(function (idx) {
            ...
            likeArray(selector) && isFunction(selector.item) ? slice$1.call(selector) : $(selector);
    ...
    slice: function () {
        return $(slice$1.apply(this, arguments));
    },
    eq: function (idx) {
